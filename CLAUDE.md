...
## Documentación — Reglas Obligatorias
...
- Si agregas modelos, migraciones o relaciones nuevas, actualiza `docs/DATABASE.md`.

- Si cambias la arquitectura (nuevos servicios, middlewares, patterns),
  actualiza `docs/ARCHITECTURE.md`.

- Al terminar cada sesión de trabajo, el `STATUS.md` debe reflejar
  el estado real del código. Nunca dejes documentación desincronizada.
